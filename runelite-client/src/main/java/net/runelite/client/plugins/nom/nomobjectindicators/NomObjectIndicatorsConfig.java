...
public interface NomObjectIndicatorsConfig extends Config
{
	...
	@ConfigItem(keyName = "bucket1InteractionCooldown", name = "Interaction Cooldown (s)", description = "Time (in seconds) to wait after stopping interaction before markers reappear.", position = 5, section = bucket1Section)
	default int bucket1InteractionCooldown() { return 0; }
	@ConfigItem(keyName = "bucket1DisableOnMove", name = "Disable while Moving", description = "Hide markers while your character is moving.", position = 6, section = bucket1Section)
	...
	@ConfigItem(keyName = "bucket2InteractionCooldown", name = "Interaction Cooldown (s)", description = "Time (in seconds) to wait after stopping interaction before markers reappear.", position = 5, section = bucket2Section)
	default int bucket2InteractionCooldown() { return 0; }
	@ConfigItem(keyName = "bucket2DisableOnMove", name = "Disable while Moving", description = "Hide markers while your character is moving.", position = 6, section = bucket2Section)
	...
	@ConfigItem(keyName = "bucket3InteractionCooldown", name = "Interaction Cooldown (s)", description = "Time (in seconds) to wait after stopping interaction before markers reappear.", position = 5, section = bucket3Section)
	default int bucket3InteractionCooldown() { return 0; }
	@ConfigItem(keyName = "bucket3DisableOnMove", name = "Disable while Moving", description = "Hide markers while your character is moving.", position = 6, section = bucket3Section)
	...
	@ConfigItem(keyName = "bucket4InteractionCooldown", name = "Interaction Cooldown (s)", description = "Time (in seconds) to wait after stopping interaction before markers reappear.", position = 5, section = bucket4Section)
	default int bucket4InteractionCooldown() { return 0; }
	@ConfigItem(keyName = "bucket4DisableOnMove", name = "Disable while Moving", description = "Hide markers while your character is moving.", position = 6, section = bucket4Section)
	...
	@ConfigItem(keyName = "bucket5InteractionCooldown", name = "Interaction Cooldown (s)", description = "Time (in seconds) to wait after stopping interaction before markers reappear.", position = 5, section = bucket5Section)
	default int bucket5InteractionCooldown() { return 0; }
	@ConfigItem(keyName = "bucket5DisableOnMove", name = "Disable while Moving", description = "Hide markers while your character is moving.", position = 6, section = bucket5Section)
	...
	@ConfigItem(keyName = "bucket6InteractionCooldown", name = "Interaction Cooldown (s)", description = "Time (in seconds) to wait after stopping interaction before markers reappear.", position = 5, section = bucket6Section)
	default int bucket6InteractionCooldown() { return 0; }
	@ConfigItem(keyName = "bucket6DisableOnMove", name = "Disable while Moving", description = "Hide markers while your character is moving.", position = 6, section = bucket6Section)
	...
	@ConfigItem(keyName = "bucket7InteractionCooldown", name = "Interaction Cooldown (s)", description = "Time (in seconds) to wait after stopping interaction before markers reappear.", position = 5, section = bucket7Section)
	default int bucket7InteractionCooldown() { return 0; }
	@ConfigItem(keyName = "bucket7DisableOnMove", name = "Disable while Moving", description = "Hide markers while your character is moving.", position = 6, section = bucket7Section)
	...
	@ConfigItem(keyName = "bucket8InteractionCooldown", name = "Interaction Cooldown (s)", description = "Time (in seconds) to wait after stopping interaction before markers reappear.", position = 5, section = bucket8Section)
	default int bucket8InteractionCooldown() { return 0; }
	@ConfigItem(keyName = "bucket8DisableOnMove", name = "Disable while Moving", description = "Hide markers while your character is moving.", position = 6, section = bucket8Section)
	...
	@ConfigItem(keyName = "bucket9InteractionCooldown", name = "Interaction Cooldown (s)", description = "Time (in seconds) to wait after stopping interaction before markers reappear.", position = 5, section = bucket9Section)
	default int bucket9InteractionCooldown() { return 0; }
	@ConfigItem(keyName = "bucket9DisableOnMove", name = "Disable while Moving", description = "Hide markers while your character is moving.", position = 6, section = bucket9Section)
