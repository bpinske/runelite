...
public class RSPlayer {
   ...
   public RSPlayer(final String userName, final double attackLevel, final double strengthLevel, final double defenseLevel, final double hitpointsLevel, final double rangedLevel) {
      ...
      this.stanceMap.put(DuelType.D_KNIFE, this.rangeStance);
   ...
   public static RSPlayer fromName(HiscoreClient hiscoreClient, final String name) {
      ...
      try {
         final double att = result.getSkill(HiscoreSkill.ATTACK).getLevel();
         final double str = result.getSkill(HiscoreSkill.STRENGTH).getLevel();
         final double def = result.getSkill(HiscoreSkill.DEFENCE).getLevel();
         final double hit = result.getSkill(HiscoreSkill.HITPOINTS).getLevel();
         final double rng = result.getSkill(HiscoreSkill.RANGED).getLevel();
